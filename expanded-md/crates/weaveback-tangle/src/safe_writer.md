...
`SafeFileWriter` is used by [`ChunkWriter`](noweb.md) in `noweb.rs`.
Baseline and source-map data is persisted to [`WeavebackDb`](db.md).
See [weaveback_tangle.adoc](weaveback_tangle.md) for the module map.
