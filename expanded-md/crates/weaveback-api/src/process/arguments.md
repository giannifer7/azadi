...
pub enum ProcessError {
    ...
    #[diagnostic(code(weaveback::process::macro_eval))]
    Macro {
        #[from]
        #[source]
        source: EvalError,
    ...
    #[diagnostic(code(weaveback::process::noweb))]
    Noweb {
        #[from]
        #[source]
    ...
    #[diagnostic(code(weaveback::process::db))]
    Db {
        #[from]
        #[source]
        source: DbError,
    ...
    #[diagnostic(code(weaveback::process::io))]
    Io {
        #[from]
        #[source]
        source: std::io::Error,
    ...
    #[error("failed to read macro prelude `{path}`")]
    #[diagnostic(code(weaveback::process::prelude_read))]
    PreludeRead {
        path: PathBuf,
        #[source]
        source: std::io::Error,
    ...
    #[error("failed to evaluate macro prelude `{path}`")]
    #[diagnostic(code(weaveback::process::prelude_eval))]
    PreludeEval {
        path: PathBuf,
        #[source]
        source: EvalError,
    ...
    #[error("failed to write expanded document `{path}`")]
    #[diagnostic(code(weaveback::process::expanded_write))]
    ExpandedWrite {
        path: PathBuf,
        #[source]
        source: std::io::Error,
