...
// <[cli main]>
#[cfg(test)]
#[path = "weaveback-macro/bin_tests.rs"]
mod bin_tests;
...
```rust
// <[@file weaveback-macro/src/bin/weaveback-macro/bin_tests.rs]>=
...
#[path = "test_macro_cli/basic.rs"]
mod basic;
#[path = "test_macro_cli/config.rs"]
mod config;
#[path = "test_macro_cli/includes.rs"]
mod includes;
#[path = "test_macro_cli/sigils.rs"]
mod sigils;
#[path = "test_macro_cli/stress.rs"]
mod stress;
#[path = "test_macro_cli/strict.rs"]
mod strict;
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/support.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/basic.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/sigils.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/includes.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/stress.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/strict.rs]>=
...
```rust
// <[@file weaveback-macro/tests/test_macro_cli/config.rs]>=
